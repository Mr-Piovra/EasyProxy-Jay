...
def create_app():
    ...
    # ✅ Graphify: Visualization tool
    async def handle_graphify(request):
        return web.FileResponse(os.path.join(static_path, 'graphify.html'))
    app.router.add_get('/graphify', handle_graphify)
